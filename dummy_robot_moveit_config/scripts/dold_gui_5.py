...
class Ui_MainWindow(object):
    ...
    def calculateCallback(self):
        ...
        try:
            ...
            response = service_conn(request.x_input, request.y_input, request.z_input, request.roll_input, request.pitch_input, request.yaw_input)
            #print(response)
        ...
        if response.success:
            ...
            self.gcodeLineEdit.setText(f"G01J1{self.xCalculatedJointsLineEdit.text()}J2{self.yCalculatedJointsLineEdit.text()}J3{self.zCalculatedJointsLineEdit.text()}J4{self.aCalculatedJointsLineEdit.text()}J5{self.bCalculatedJointsLineEdit.text()}J6{self.cCalculatedJointsLineEdit.text()}")
